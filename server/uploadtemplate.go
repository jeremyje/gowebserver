...
<body>
  ...
  <div class="container" role="main">
    ...
    <nav role="navigation">
      <a href="{{.UploadServePath}}" class="is-selected">Auto Submit</a>
      <a href="{{.UploadServePath}}">Submit On Demand</a>
    </nav>

    <form method="post" action="{{.UploadServePath}}" enctype="multipart/form-data" novalidate class="box">
      ...
      <div class="box__success">Done! <a href="{{.UploadServePath}}" class="box__restart" role="button">Upload more?</a></div>
      <div class="box__error">Error! <span></span>. <a href="{{.UploadServePath}}" class="box__restart" role="button">Try again!</a></div>
    </form>
