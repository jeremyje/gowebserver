...
curl -o gowebserver -O -L https://github.com/jeremyje/gowebserver/releases/download/v3.0.0/server-amd64; chmod +x gowebserver
...
./gowebserver --path=https://github.com/jeremyje/gowebserver/archive/v3.0.0.zip
...
|   OS   | Arch  | Link
|--------|-------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------
|Linux   | amd64 | `curl -O -L https://github.com/jeremyje/gowebserver/releases/download/v3.0.0/server-amd64`
|Linux   | arm   | `curl -O -L https://github.com/jeremyje/gowebserver/releases/download/v3.0.0/server-arm`
|Linux   | arm64 | `curl -O -L https://github.com/jeremyje/gowebserver/releases/download/v3.0.0/server-arm64`
|Windows | amd64 | `(New-Object System.Net.WebClient).DownloadFile("https://github.com/jeremyje/gowebserver/releases/download/v3.0.0/server-amd64.exe", "server-amd64.exe")`
|macOS   | amd64 | `curl -O -L https://github.com/jeremyje/gowebserver/releases/download/v3.0.0/server-amd64-darwin`
|macOS   | arm64 | `curl -O -L https://github.com/jeremyje/gowebserver/releases/download/v3.0.0/server-arm64-darwin`
